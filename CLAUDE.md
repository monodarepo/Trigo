...
- Monoda: `monoda-logo-para-fundo-escuro.png` (raiz) → cópia de uso `public/brand/monoda-logo-branco.png` (494×148, conteúdo de borda a borda, lockup completo com símbolo + wordmark, aspecto ~3,34:1). Aparece ao lado da M. Dias Branco no login, um pouco MENOR em altura: no mesmo tamanho ficaria mais larga e pesada que a marca do cliente na tela do próprio cliente.
